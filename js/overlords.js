...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var THRONE_THEMES = {
    ...
    'zura-kaleth': { accent: '#e59048', glow: 'rgba(229,144,72,0.56)', motif: 'Ritual fire', scene: 'ember', particle: 'ember' },
    ...
    'maerion-thal': { accent: '#f0c479', glow: 'rgba(240,196,121,0.54)', motif: 'Reflected faces', scene: 'water', particle: 'water' },
    'marion-thal': { accent: '#f0c479', glow: 'rgba(240,196,121,0.54)', motif: 'Reflected faces', scene: 'water', particle: 'water' }
  };
  ...
  function renderNavButton(direction, neighbor) {
    ...
    return '<button class="throne-ring-nav throne-ring-nav--' + direction + '" type="button" data-throne-direction="' + direction + '" aria-label="' + (isPrevious ? 'Previous' : 'Next') + ' Overlord: ' + escapeHtml(neighbor.name) + '"><span class="throne-ring-nav-diamond" aria-hidden="true">' + (isPrevious ? '&#8249;' : '&#8250;') + '</span><span>' + (isPrevious ? 'Previous' : 'Next') + '</span></button>';
  }
