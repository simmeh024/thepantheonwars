...
function pw_dispatch_diff_context_from_paths(array $paths): array
{
    ...
    $areaRules = [
        'api/oauth' => 'member sign-in services',
        'api/user-sessions' => 'member session services',
        'api/admin' => 'the Admin Console',
        'admin/' => 'the Admin Console',
        'api/' => 'site services',
        'tools/' => 'local site tooling',
        'css/' => 'the visual interface',
        'js/' => 'interactive site behaviour',
        'sql/' => 'the site database',
        'images/' => 'site imagery',
        'uploads/' => 'member uploads',
        'profile' => 'member profile features',
