...
$allowedTypes = ['like', 'mention', 'quote', 'report_resolved', 'world_available', 'news_published', 'topic_reply', 'icon_unlocked', 'direct_message', 'new_device_login', 'warning_issued', 'weather_alert'];
$types = [];
if (!empty($_GET['types'])) {
