...
$counts = ['like' => 0, 'mention' => 0, 'quote' => 0, 'report_resolved' => 0, 'world_available' => 0, 'news_published' => 0, 'topic_reply' => 0, 'icon_unlocked' => 0, 'direct_message' => 0, 'new_device_login' => 0, 'warning_issued' => 0, 'weather_alert' => 0, 'mission_ready' => 0];
$total = 0;
$unread = 0;
foreach ($rows as $r) {
