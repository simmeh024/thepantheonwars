...
$stmt = $db->prepare('SELECT notif_like, notif_mention, notif_quote, notif_report_resolved, notif_world_available, notif_news_published FROM notification_preferences WHERE user_id = ?');
