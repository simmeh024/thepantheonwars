...
$stmt = $db->prepare('SELECT notif_like, notif_mention, notif_quote, notif_report_resolved, notif_world_available, notif_news_published, notif_topic_reply, notif_icon_unlocked, notif_new_device_login, notif_warning_issued FROM notification_preferences WHERE user_id = ?');
