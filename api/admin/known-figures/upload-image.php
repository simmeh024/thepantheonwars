<?php
/**
 * Known Figures Control image upload endpoint. Mirrors
 * api/admin/overlords/upload-image.php exactly (multipart/form-data, GD
...
pw_require_permission('known_figures.edit');
...
// uploads/known-figure-images/portraits ships with a committed .htaccess
// (same as uploads/overlord-images/*) -- not generated here, so the
// directory is never briefly unprotected between creation and first upload.
$uploadDir = __DIR__ . '/../../../uploads/known-figure-images/' . $folderName;
if (!is_dir($uploadDir)) {
...
pw_json(['ok' => true, 'url' => '/uploads/known-figure-images/' . $folderName . '/' . $filename]);
