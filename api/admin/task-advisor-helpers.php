...
function pw_collect_task_advisor($db, array $systemSignals) {
    ...
    $systemAlertSpecs = [
        ...
        'mail' => ['type' => 'mail', 'title' => 'Transactional mail service is disconnected', 'reason' => 'BH-4 could not access the configured mail transport. Password recovery and transactional delivery cannot be sent until the mail connection is restored.'],
    ];
