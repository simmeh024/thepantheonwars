...
function pw_collect_task_advisor($db, array $systemSignals) {
    ...
    $criticalPriority = ['security', 'spacy', 'mail', 'backup', 'database', 'database_load', 'sql_performance', 'forum', 'dispatch_sync', 'storage', 'github'];
    $criticalAlerts = [];
    ...
    $systemAlertSpecs = [
        ...
        'mail' => ['type' => 'mail', 'title' => 'Transactional mail service is disconnected', 'reason' => 'BH-4 could not access the hosting PHP mail transport. Password recovery and transactional delivery cannot be sent until the mail connection is restored.'],
    ];
